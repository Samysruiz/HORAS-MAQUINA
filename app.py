...
def show_logo(width=220, center=False):
    ...
    if b64:
        ...
        st.markdown(
            f'<div style="text-align:{align}"><img src="data:image/png;base64,{b64}" width="{width}px"></div>',
            unsafe_allow_html=True
        )
    else:
        st.markdown(f"<h2 style='color:#E41E26;'>🚜 Sandro Bobcat</h2>", unsafe_allow_html=True)
